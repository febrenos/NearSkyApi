...
exports.convertEpochToISO8601 = exports.getDayOfWeek = exports.getStartEndDate = exports.formatDate = exports.formatDateISO = void 0;
const models_1 = require("../models");
function formatDateISO(date) {
    return new Date(date).toISOString().slice(0, 10);
}
exports.formatDateISO = formatDateISO;
function formatDate(date, initialFormat, finalFormat) {
...
function getStartEndDate(currentDate, daysAhead, startDate, endDate) {
    function formatDateIntern(date, initialFormat, finalFormat) {
        initialFormat = initialFormat.toUpperCase();
        finalFormat = finalFormat.toUpperCase();
        let ddPosition = initialFormat.indexOf('DD');
        let mmPosition = initialFormat.indexOf('MM');
...
function getDayOfWeek(currentDate, date, language) {
    ...
    const translations = {
        [models_1.LanguageModelDictionary.Arabic]: 'اليوم', // Arabic
        [models_1.LanguageModelDictionary.Bulgarian]: 'днес', // Bulgarian
        [models_1.LanguageModelDictionary.Czech]: 'dnes', // Czech
        [models_1.LanguageModelDictionary.Danish]: 'i dag', // Danish
        [models_1.LanguageModelDictionary.German]: 'heute', // German
        [models_1.LanguageModelDictionary.Greek]: 'σήμερα', // Greek
        [models_1.LanguageModelDictionary.English]: 'Today', // English
        [models_1.LanguageModelDictionary.AmericanEnglish]: 'Today', // American English
        [models_1.LanguageModelDictionary.Spanish]: 'hoy', // Spanish
        [models_1.LanguageModelDictionary.Persian]: 'امروز', // Persian
        [models_1.LanguageModelDictionary.Finnish]: 'tänään', // Finnish
        [models_1.LanguageModelDictionary.French]: 'aujourd\'hui', // French
        [models_1.LanguageModelDictionary.Hebrew]: 'היום', // Hebrew
        [models_1.LanguageModelDictionary.Hungarian]: 'ma', // Hungarian
        [models_1.LanguageModelDictionary.Indonesian]: 'hari ini', // Indonesian
        [models_1.LanguageModelDictionary.Italian]: 'oggi', // Italian
        [models_1.LanguageModelDictionary.Japanese]: '今日', // Japanese
        [models_1.LanguageModelDictionary.Korean]: '오늘', // Korean
        [models_1.LanguageModelDictionary.Dutch]: 'vandaag', // Dutch
        [models_1.LanguageModelDictionary.Polish]: 'dzisiaj', // Polish
        [models_1.LanguageModelDictionary.BrazilianPortuguese]: 'Hoje', // Brazilian Portuguese
        [models_1.LanguageModelDictionary.Portuguese]: 'Hoje', // Portuguese
        [models_1.LanguageModelDictionary.Russian]: 'сегодня', // Russian
        [models_1.LanguageModelDictionary.Slovak]: 'dnes', // Slovak
        [models_1.LanguageModelDictionary.Serbian]: 'данас', // Serbian
        [models_1.LanguageModelDictionary.Swedish]: 'idag', // Swedish
        [models_1.LanguageModelDictionary.Turkish]: 'bugün', // Turkish
        [models_1.LanguageModelDictionary.Ukrainian]: 'сьогодні', // Ukrainian
        [models_1.LanguageModelDictionary.Vietnamese]: 'hôm nay', // Vietnamese
        [models_1.LanguageModelDictionary.Chinese]: '今天', // Chinese
    };
...
function convertEpochToISO8601(datetimeEpoch, roundMinutes) {
...
exports.convertEpochToISO8601 = convertEpochToISO8601;
